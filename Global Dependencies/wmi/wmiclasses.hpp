...
struct Win32_MotherboardDevice
{
	...
	static std::string getWmiClassName()
	{
		return "Win32_MotherboardDevice";
	}
...
{
	Win32_BaseBoard() :
		DeviceID(), PNPDeviceID(), SerialNumber()
	{}
